-- Host Applications host-only face verification list + stats
-- Keeps Admin User Hub all-user, while Host Applications counts/lists only host/female applications.
