...
BEGIN
  ...
  -- Relaxed thresholds (Pkg-face-auto-v3): gender 80% (was 86%), compare 65% (was 72%),
  -- face_conf 80% kept. Underage + occlusion checks unchanged.
  IF v_gender_conf < 80 OR v_fl < 65 OR v_fr < 65 OR v_face_conf < 80 THEN
