...
BEGIN
  ...
  IF _call.viewer_rate_per_min IS NULL
    ...
    -- Admin Single Source of Truth: NO hardcoded fallback.
  ...
  -- Write ONLY columns that exist. settle_private_call reads total_coins_deducted
  -- and host_earned, so writing them per tick prevents the end-of-call double-charge.
  UPDATE public.private_calls
