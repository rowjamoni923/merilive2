-- =============================================================
-- Add bypass flag to 6 admin RPCs that update protected profile
-- columns. Mirrors the existing pattern used by admin_block_user.
-- =============================================================
...
-- 4. admin_permanent_ban_step_three
