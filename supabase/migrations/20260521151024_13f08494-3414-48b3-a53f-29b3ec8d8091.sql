...
BEGIN
  ...
  -- UNIFIED %: Host এবং User উভয়ের জন্য একই admin-set host_percent
  ...
  -- Unified credit path for Host and User receivers
  ...
  INSERT INTO public.gift_transactions (
    sender_id, receiver_id, gift_id, quantity, total_coins, beans_received,
    stream_id, party_room_id, call_id, reel_id, created_at
  ) VALUES (
    p_sender_id, p_receiver_id, p_gift_id, _qty, _total_cost, _beans_amount,
