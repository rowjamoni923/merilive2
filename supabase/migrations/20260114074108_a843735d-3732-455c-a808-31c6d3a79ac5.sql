-- Add tiered commission settings and transfer schedule to app_settings
-- This will be managed via app_settings table with commission_tiers and transfer_schedule keys

-- Update the default agency commission to 2% and add tiered structure
-- Also add coins_to_dollar_rate for conversion

-- Update the process_weekly_agency_transfers function to support tiered commissions
...
BEGIN
  ...
  -- Default to 2% if not set (changed from 10%)
