...
-- Fix: Use pure UTC timing (universal, works for ALL timezones)
-- No timezone dependency - just distributes for the previous UTC day/week/month
...
-- Fix distribute_period_rewards: Pure UTC, no timezone dependency
...
BEGIN
  ...
  -- Idempotent check: already distributed for this period?
  SELECT EXISTS (
