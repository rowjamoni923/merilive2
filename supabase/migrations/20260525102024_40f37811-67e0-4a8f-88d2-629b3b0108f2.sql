-- Pkg330 home page audit pass-2
-- Tighten public home feed data and banner exposure.
...
-- Banner policy cleanup: keep public visibility only for active, scheduled rows.
...
CREATE POLICY "public_read_active_home_banners_pkg330"
ON public.banners
FOR SELECT
TO anon, authenticated
USING (
  COALESCE(is_active, false) = true
  AND COALESCE(location, 'home') = 'home'
