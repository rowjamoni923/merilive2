...
-- ============================================================
-- Manual audit finding: older reward RPC overloads / wrappers can drift from
-- the audited canonical logic. Keep one canonical claim implementation.

DROP FUNCTION IF EXISTS public.claim_task_reward(uuid, uuid);
DROP FUNCTION IF EXISTS public.claim_daily_login_reward();
DROP FUNCTION IF EXISTS public.update_task_progress(text);
