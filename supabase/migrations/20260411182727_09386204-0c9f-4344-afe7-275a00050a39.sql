...
-- Fix 1: Add primary key to profiles table
ALTER TABLE public.profiles ADD PRIMARY KEY (id);

-- Fix 2: Recreate create_agency_for_user to bypass trigger properly
...
BEGIN
  ...
  -- Update user profile (SET role = 'postgres' at function level bypasses the trigger)
  UPDATE profiles
