...
-- Fix: Use session_user vs current_user to detect SECURITY DEFINER context
-- In SECURITY DEFINER functions, current_user = function owner (postgres), session_user = original caller
