...
BEGIN
  ...
  IF NOT EXISTS (
    ...
    WHERE pubname = 'supabase_realtime'
      AND schemaname = 'public'
      AND tablename = 'topup_helpers'
  ) THEN
    ALTER PUBLICATION supabase_realtime ADD TABLE public.topup_helpers;
  END IF;
  ...
  IF NOT EXISTS (
    ...
    WHERE pubname = 'supabase_realtime'
      AND schemaname = 'public'
      AND tablename = 'face_verification_submissions'
  ) THEN
    ALTER PUBLICATION supabase_realtime ADD TABLE public.face_verification_submissions;
  END IF;
END $$;