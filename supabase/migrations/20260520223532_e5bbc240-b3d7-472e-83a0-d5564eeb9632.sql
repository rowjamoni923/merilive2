...
BEGIN
  ...
  -- Rows inserted as "submitted" are normalized by trigger to "pending".
  -- Treat both as analyzable pending-review states for auto-finalize.
  ...
  -- Aligned with face-verification-analyze edge function:
  -- gender_confidence >= 86 (edge already filters), face_confidence >= 80.
  -- Side-angle CompareFaces kept for audit only (users turn head -> unreliable).
