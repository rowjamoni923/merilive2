-- Section #9 Gift Pipeline hardening pass 2: enforce gift level gates server-side
...
REVOKE ALL ON FUNCTION public.process_gift_transaction(uuid, uuid, uuid, integer, uuid, uuid, uuid, uuid) FROM service_role;
