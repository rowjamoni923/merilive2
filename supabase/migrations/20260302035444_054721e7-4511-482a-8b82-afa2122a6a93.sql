...
-- Add exception handling to distribute_period_rewards to catch and log errors
    ...
    FOR v_entry IN (
      ...
      IF v_reward IS NOT NULL THEN
        ...
        EXCEPTION WHEN OTHERS THEN
          RAISE WARNING 'Reward distribution error for user % rank %: %', v_entry.user_id, v_rank, SQLERRM;
        END;
      END IF;
    END LOOP;
  END IF;
    ...
    FOR v_entry IN (
      ...
      IF v_reward IS NOT NULL THEN
        ...
        BEGIN
          ...
          v_count := v_count + 1;
        EXCEPTION WHEN OTHERS THEN
          RAISE WARNING 'Game reward error for user % rank %: %', v_entry.user_id, v_rank, SQLERRM;
        END;
      END IF;
    END LOOP;
  END IF;
    ...
    FOR v_entry IN (
      ...
      IF v_reward IS NOT NULL THEN
        ...
        BEGIN
          ...
          v_count := v_count + 1;
        EXCEPTION WHEN OTHERS THEN
          RAISE WARNING 'Gifter reward error for user % rank %: %', v_entry.user_id, v_rank, SQLERRM;
        END;
      END IF;
    END LOOP;
  END IF;
    ...
    FOR v_entry IN (
      ...
      IF v_reward IS NOT NULL THEN
        ...
        BEGIN
          ...
          v_count := v_count + 1;
        EXCEPTION WHEN OTHERS THEN
          RAISE WARNING 'Agency reward error for agency % rank %: %', v_entry.agency_id, v_rank, SQLERRM;
        END;
      END IF;
    END LOOP;
  END IF;
