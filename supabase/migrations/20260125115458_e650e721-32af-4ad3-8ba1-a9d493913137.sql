-- Fix the deduct_call_coins_per_minute function to use correct column name
-- The column is 'coins', not 'diamond_balance'
...
BEGIN
  ...
  -- Check caller balance (FIXED: using 'coins' column, not 'diamond_balance')
  ...
  -- Deduct from caller (FIXED: using 'coins' column)
  UPDATE profiles 
