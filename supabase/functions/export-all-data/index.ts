...
const HARDCODED_TABLES: string[] = [
  ...
  "categories","channels","chat_bubbles","chat_moderation_logs","coin_packages","coin_trader_transfers",
  "coin_transactions","coin_transfers","consumption_return_config","consumption_return_history",
