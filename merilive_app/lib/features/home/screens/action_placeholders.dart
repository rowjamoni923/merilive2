...
// C7 — RandomCallPlaceholderPage removed. Real Match Call surface lives at
...
// LiveStreamPlaceholderPage removed — replaced by the real
// `LiveStreamPage` shell at features/live/screens/live_stream_page.dart
// (A1 of the Full-Parity Sprint). Host teardown now lives inside that
// page's dispose(); GoLive still hands off via `LiveHostBridge` so the
// Camera2 sensor is never re-initialised between prejoin → publish.
