            ...
            child: Row(
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: (isCredit ? Colors.green : Colors.amber).withOpacity(0.1),
                    shape: BoxShape.circle,
                  ),
                  child: Icon(
                    isCredit ? LucideIcons.trendingUp : LucideIcons.repeat,
                    color: isCredit ? Colors.greenAccent : Colors.amberAccent,
                    size: 16,
                  ),
                ),
                const SizedBox(width: 16),
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        log['description'] ?? (isCredit ? "Bean Earnings" : "Bean Exchange"),
