            ...
            child: Row(
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: (isCredit ? Colors.amber : Colors.orange).withOpacity(0.1),
                    shape: BoxShape.circle,
                  ),
                  child: Icon(
                    isCredit ? LucideIcons.coins : LucideIcons.send,
                    color: isCredit ? Colors.amberAccent : Colors.orangeAccent,
                    size: 16,
                  ),
                ),
                const SizedBox(width: 16),
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        log['description'] ?? (isCredit ? "Coin Transfer Recv" : "Coin Transfer Sent"),
