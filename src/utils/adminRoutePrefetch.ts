...
const ROUTE_IMPORTERS: Record<string, Importer> = {
  ...
  '/admin/diamonds': () => import('@/pages/admin/AdminDiamonds'),
  '/admin/coins': () => import('@/pages/admin/AdminDiamonds'),
  '/admin/pricing-hub': () => import('@/pages/admin/AdminPricingHub'),
  '/admin/finance': () => import('@/pages/admin/AdminFinance'),
  '/admin/diamond-traders': () => import('@/pages/admin/AdminDiamondTraders'),
  '/admin/diamond-traders': () => import('@/pages/admin/AdminDiamondTraders'),
  ...
  '/admin/diamond-traders/approvals': () => import('@/pages/admin/AdminTopupTraderApprovals'),
  '/admin/diamond-traders/orders': () => import('@/pages/admin/AdminTraderOrders'),
  '/admin/diamond-traders/transactions': () => import('@/pages/admin/AdminTraderTransactions'),
  '/admin/diamond-traders/approvals': () => import('@/pages/admin/AdminTopupTraderApprovals'),
  '/admin/diamond-traders/orders': () => import('@/pages/admin/AdminTraderOrders'),
  '/admin/diamond-traders/transactions': () => import('@/pages/admin/AdminTraderTransactions'),
  ...
  '/admin/diamond-trader-hub': () => import('@/pages/admin/AdminDiamondTraderHub'),
  '/admin/diamond-trader-hub': () => import('@/pages/admin/AdminDiamondTraderHub'),
  ...
  '/admin/livekit-ingress': () => import('@/pages/admin/AdminLiveKitIngress'),
  '/admin/livekit-sip': () => import('@/pages/admin/AdminLiveKitSip'),
  '/admin/livekit-webhook': () => import('@/pages/admin/AdminLiveKitWebhook'),
