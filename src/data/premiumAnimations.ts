...
export const premiumAnimations: PremiumAnimation[] = [
  ...
  { id: 'gift_bronze_coin', name: 'Bronze Diamond Gift', category: 'privilege_gift', tier: 'bronze', unlockLevel: 3, previewColor: '#CD7F32', animationData: createAdvancedLottieAnimation('Bronze Diamond', '#CD7F32', '#8B4513', '#D2691E', 'rotate', 'ring') },
