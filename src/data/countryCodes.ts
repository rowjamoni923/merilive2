...
export const COUNTRY_CODES: CountryCode[] = [
  ...
  { code: "+1268", country: "AG", name: "Antigua & Barbuda", flag: "🇦🇬" },
  ...
  { code: "+599", country: "BQ", name: "Bonaire", flag: "🇧🇶" },
  ...
  { code: "+1869", country: "KN", name: "Saint Kitts & Nevis", flag: "🇰🇳" },
  ...
  { code: "+1868", country: "TT", name: "Trinidad & Tobago", flag: "🇹🇹" },
  { code: "+216", country: "TN", name: "Tunisia", flag: "🇹🇳" },
  { code: "+90", country: "TR", name: "Turkey", flag: "🇹🇷" },
  { code: "+993", country: "TM", name: "Turkmenistan", flag: "🇹🇲" },
  { code: "+1649", country: "TC", name: "Turks & Caicos Islands", flag: "🇹🇨" },
...
// Get country by country code (ISO 2-letter)
export const getCountryByCode = (countryCode: string): CountryCode | undefined => {
  return COUNTRY_CODES.find(c => c.country === countryCode.toUpperCase());
};
