                            ...
                            <div className="flex items-center gap-3">
                              <div className="relative">
                                <Avatar className="w-10 h-10 border-2 border-slate-200">
                                  <UserAvatarImage gender={((user) as any)?.gender} seed={((user) as any)?.id ?? ((user) as any)?.user_id ?? ((user) as any)?.host_id} src={user.avatar_url || undefined} />
                          ...
                          <TableCell>
                            <div className="flex items-center gap-3">
                              <Avatar className="w-10 h-10 border-2 border-pink-500/50">
                                <UserAvatarImage gender={((host) as any)?.gender} seed={((host) as any)?.id ?? ((host) as any)?.user_id ?? ((host) as any)?.host_id} src={host.avatar_url || ""} />
                          ...
                          <TableCell>
                            <div className="flex items-center gap-3">
                              <Avatar className="w-10 h-10 border-2 border-emerald-500/50">
                                <UserAvatarImage gender={((u) as any)?.gender} seed={((u) as any)?.id ?? ((u) as any)?.user_id ?? ((u) as any)?.host_id} src={u.avatar_url || ""} />
                    ...
                    <CardContent className="p-4">
                      <div className="flex items-start gap-3">
                        <Avatar className="w-16 h-16 border-2 border-cyan-300">
                          <UserAvatarImage gender={((sub) as any)?.gender} seed={((sub) as any)?.id ?? ((sub) as any)?.user_id ?? ((sub) as any)?.host_id} src={sub.profile_photo_url || sub.profile?.avatar_url || undefined} />
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4">
                <Avatar className="w-16 h-16 border-2 border-purple-500/50">
                  <UserAvatarImage gender={((selectedUser) as any)?.gender} seed={((selectedUser) as any)?.id ?? ((selectedUser) as any)?.user_id ?? ((selectedUser) as any)?.host_id} src={selectedUser.avatar_url || undefined} />
