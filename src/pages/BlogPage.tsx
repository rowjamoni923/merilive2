        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div 
              ...
              onClick={() => navigate("/")}
            >
              <img loading="lazy" decoding="async" src={meriliveLogo} alt="MeriLive" className="w-10 h-10 rounded-xl object-contain" />
              <div>
        ...
        <div className="container mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <img loading="lazy" decoding="async" src={meriliveLogo} alt="MeriLive" className="w-8 h-8 rounded-lg object-contain" />
