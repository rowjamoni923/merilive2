...
const [levelTiers, setLevelTiers] = useState<LevelTier[]>([]);
  ...
  return (
    <div className="fixed inset-0 flex flex-col profile-home-shell overflow-hidden">
      ...
      <div className="relative mx-3 mt-3 pt-10 pb-5 px-4 flex flex-col items-center profile-hero-panel rounded-2xl overflow-hidden">
        ...
        {profile?.app_uid && (
          <button 
            className="mt-2 flex items-center gap-2 bg-white/10 hover:bg-white/15 border border-white/10 px-4 py-2 rounded-full transition-all"
            onClick={() => {
        ...
        >
          <div className="text-center">
            ...
            <p className="text-xs text-white/85 font-medium">Friends</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-xs text-white/85 font-medium">Following</p>
          </div>
          <div className="w-px h-10 bg-gradient-to-b from-transparent via-white/15 to-transparent" />
          <div className="text-center">
            <p className="text-2xl font-bold text-white">{stats.followersCount}</p>
            <p className="text-xs text-white/85 font-medium">Followers</p>
          </div>
        </div>
            ...
            >
              ...
              <div className="relative profile-home-card rounded-xl p-2.5 overflow-hidden group-active:scale-[0.97] transition-transform">
                ...
                <div className="relative z-10">
                  ...
                  <p className={`text-xl font-bold ${beans < 0 ? 'text-red-600' : 'text-slate-950'}`}>{beans.toLocaleString()}</p>
                </div>
                ...
                <div className="relative z-10 flex items-center justify-between">
                  <div>
                    <div className="flex items-center gap-1.5 mb-1">
                      <p className="text-slate-950 font-semibold text-sm tracking-tight">Trader Wallet</p>
            ...
            <Tabs value={transferTab} onValueChange={(v) => {
                  ...
                  <div className="bg-slate-800/60 rounded-2xl p-4 border border-cyan-500/30 space-y-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-slate-200 text-sm">ID: {searchedUser.app_uid}</p>
                      </div>
                    </div>
              ...
              <TabsContent value="agency" className="mt-4 space-y-4">
                ...
                <div>
                  ...
                  <p className="text-slate-200 text-xs mt-1 mb-2">Enter the agency owner's user ID to find their agency</p>
                ...
                <div className="bg-gradient-to-r from-amber-500/10 to-orange-500/10 rounded-2xl p-4 border border-amber-500/30 space-y-4">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <div>
                      ...
                      <p className="text-slate-200 text-xs">Transfer from Trader Wallet → My Diamond Balance</p>
                    </div>
                  </div>
              ...
              <TabsContent value="history" className="mt-4 space-y-3 max-h-[420px] overflow-y-auto">
                {historyLoading ? (
                  ...
                  <div className="text-center py-10">
                    ...
                    <p className="text-slate-200 text-sm">No transfer history yet</p>
                    <p className="text-slate-300 text-xs mt-1">Your coin trade transfers will appear here</p>
                  </div>
                ) : (
              ...
              <p className="text-slate-300 text-sm">
                {pendingTransferType === "user" ? (
                  <>
                    ...
                    <br />
                    <span className="text-slate-300 text-xs">UID: {searchedUser?.app_uid}</span>
                  </>
                ) : pendingTransferType === "self" ? (
                  <>
                    Recharge to <span className="text-amber-400 font-semibold">My Diamond Balance</span>
                    <br />
                    <span className="text-slate-300 text-xs">From Trader Wallet → My Balance</span>
                  </>
                ) : (
                  <>
            ...
            {parseInt(exchangeBeansAmount) > 0 && (
              <div className="bg-gradient-to-r from-emerald-500/20 to-teal-500/20 rounded-xl p-4 border border-emerald-500/30">
                ...
                <div className="flex items-center justify-between text-sm mt-1">
                  <span className="text-slate-200">Beans After Fee</span>
                ...
                <div className="flex items-center justify-between text-sm mt-1 pt-2 border-t border-emerald-500/30">
                  <span className="text-slate-200">Total Beans Deducted</span>
