...
/**
 * Native broadcast beauty is disabled. Keep the flag helpers only so older
 * admin/UI code that reads/writes this local key stays harmless.
 */
...
/**
 * Compatibility no-op. Never touches NativeLiveKit or the camera track.
 */
