...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "absolute right-2 top-2 rounded-md p-1 text-white/70 opacity-100 transition-opacity hover:text-white group-[.destructive]:text-white/80 group-[.destructive]:hover:text-white focus:opacity-100 focus:outline-none focus:ring-2 focus:ring-white/30",
      className,
    )}
    toast-close=""
    {...props}
