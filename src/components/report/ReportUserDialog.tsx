...
export const ReportUserDialog = forwardRef<HTMLDivElement, ReportUserDialogProps>(function ReportUserDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent ref={ref} className="bg-gradient-to-b from-[#FAF5EA]/98 via-[#FFFBF2]/98 to-[#FFFBF2]/98 backdrop-blur-3xl border border-amber-200/60 text-slate-800 max-w-[360px] rounded-2xl p-0 overflow-hidden shadow-2xl shadow-purple-900/40 [&>button]:hidden">
        ...
        <div className="p-5 pt-6">
          ...
          <div className="space-y-2.5">
            <Button
              ...
              className="w-full h-12 bg-gradient-to-r from-red-600 via-rose-500 to-red-600 hover:from-red-500 hover:via-rose-400 hover:to-red-500 text-slate-800 font-semibold rounded-xl shadow-lg shadow-red-500/20 transition-all disabled:opacity-40 disabled:shadow-none"
            >
              {submitting ? (
                <motion.div
                  animate={{ rotate: 360 }}
