    ...
    <div className="space-y-4 px-4 mt-4">
      ...
      {noble && (
        ...
        >
          <div className="flex items-center gap-3">
            {noble.crown_url ? (
              <img src={noble.crown_url} alt="" className="w-12 h-12 object-contain" loading="eager"/>
            ) : (
            ...
            return (
              ...
              >
                ...
                >
                  <div className="flex items-center gap-3">
                    {card.crown_url ? (
                      <img src={card.crown_url} alt="" className="w-10 h-10 object-contain" loading="eager"/>
                    ) : (
                ...
                <div className="p-3 space-y-2">
                  ...
                  {card.entrance_animation_url && (
                    <div className="w-16 h-16 bg-amber-50 border border-amber-200/60 rounded overflow-hidden">
