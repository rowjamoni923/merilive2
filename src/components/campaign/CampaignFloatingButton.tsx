                          ...
                          >
                            <div className="flex items-center gap-2">
                              <div className={`w-8 h-8 rounded-xl flex items-center justify-center text-base overflow-hidden ${isSelected ? 'bg-white/20' : 'bg-indigo-50'}`}>
                                {gw.logo_url ? (
                                  <img src={logoCdn(gw.logo_url)} alt="" loading="eager" decoding="async" className="w-full h-full object-cover" onError={(e) => { const t = e.currentTarget; if (gw.logo_url && t.src !== gw.logo_url) t.src = gw.logo_url; }} />
                                ) : (
                                  gatewayIcon(gw)
                                )}
                              </div>
                          ...
                          <div className="flex items-center gap-2">
                            <div className="w-9 h-9 rounded-xl bg-amber-500/20 flex items-center justify-center overflow-hidden">
                              {currentMethod.logo_url ? (
                                <img src={logoCdn(currentMethod.logo_url)} alt={currentMethod.method_name} loading="eager" decoding="async" className="h-6 w-6 object-contain" onError={(e) => { const t = e.target as HTMLImageElement; if (currentMethod.logo_url && t.src !== currentMethod.logo_url) { t.src = currentMethod.logo_url; return; } t.style.display = 'none'; }} />
                              ) : (
                          ...
                          <div className="mt-1">
                            {helperPaymentProof ? (
                              <div className="relative rounded-xl overflow-hidden border border-white/10">
                                <img src={proofCdn(helperPaymentProof)} alt="Proof" loading="eager" decoding="async" className="w-full h-20 object-cover" onError={(e) => { const t = e.currentTarget; if (helperPaymentProof && t.src !== helperPaymentProof) t.src = helperPaymentProof; }} />
