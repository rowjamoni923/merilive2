...
export const EpayGlobalBanner = () => (
  <div className="rounded-2xl overflow-hidden relative">
    <img loading="lazy" decoding="async" src={epayBg} alt="" className="w-full h-auto object-cover" />
...
export const LocalCurrencyBanner = () => (
  <div className="rounded-2xl overflow-hidden relative">
    <img loading="lazy" decoding="async" src={localCurrencyBg} alt="" className="w-full h-auto object-cover" />
...
export const DailyTransactionLimitsBanner = () => (
  <div className="rounded-2xl overflow-hidden relative">
    <img loading="lazy" decoding="async" src={countryPaymentBg} alt="" className="absolute inset-0 w-full h-full object-cover" />
