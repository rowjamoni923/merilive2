...
const RouteSuspenseFallback = memo(() => {
  ...
  if (isAuthRoute) {
    return (
      <div data-page-root="route-fallback-auth" className="fixed inset-0 overflow-hidden text-white" style={{ background: 'linear-gradient(135deg, #0f0c29 0%, #302b63 42%, #24243e 72%, #0f0c29 100%)' }} aria-hidden="true">
