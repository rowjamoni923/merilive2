...
- Admin popup-banner form now defaults the close delay to 3 seconds and no longer shows misleading Link/Auto Dismiss controls for this image-only interstitial behavior.
